...
Ranking-focused peer review also leads to excessively negative feedback. Feedback will be unavoidably negative reviewers feel obligated to justify their ratings to their fellow committee members, to themselves, and to the authors. When rejecting a submission that feedback will inherently be mostly negative, even if committees try to encourage reviewers to list some positives for every paper and to be constructive when providing negative feedback. A system that must reject the majority of papers will provide much more negative feedback to the community than positive feedback, which is harmful to the community's mental health and particularly toxic to the most junior and least powerful members.
