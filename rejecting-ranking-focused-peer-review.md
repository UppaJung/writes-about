...
Peer review cannot help but have systemically toxic negativity when co-opted for ranking. It's unavoidable because reviewers feel obligated to provide feedback that justifies the outcome to their fellow committee members, to themselves, and to the authors. When rejecting a submission that feedback will inherently be mostly negative, even if committees try to encourage that the negative feedback be constructive. A system that must reject the majority of papers will provide much more negative feedback to the community than positive feedback, which is harmful to the community's mental health and particularly harmful to the most junior and least powerful members.
...
We feel obligated to participate in peer review because of its importance for protecting scientific integrity, but it is nearly impossible to do without becoming complicit in the toxicity of rank-focused review. We are obligated to work with reviewers who abuse the subjectivity and anonymity of peer review, and obligated to protect their identities, while witnessing the trauma that negative feedback inflicts on others, especially promising aspiring scientists who abandon careers in research.
...
For established scientists who survived and inherited the toxic system from our heros and mentors, we must be honest with the public about how ranking co-opts scientific integrity in peer review, and we must take responsibility for how our choices perpetuate this system. When we give objective outsiders the opportunity examine the consequences of using peer review for ranking, we should expect them to come to the conclusion that's obvious to anyone who hasn't received years of conditioning to accept it: *reject*.
