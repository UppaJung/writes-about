...
When we depict the purpose of peer review as preventing scientists from unwittingly misleading ourselves and the public, and elide how we use peer review for ranking, we are already misleading ourselves and the public—because co-opting peer review for ranking subverts science in ways that mislead us all.
...
*Ranking corrupts the very term peer review.* At the lower strata are publications that peer review in name only, accepting any paper for which authors will pay publication fees or conference-registration fees. When we use *peer reviewed* synonymously with *accepted for publication* the term loses all value as an indicator of scientific integrity.
