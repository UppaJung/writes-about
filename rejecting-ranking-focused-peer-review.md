...
*The process of submitting and re-submitting work to new reviewers takes time away from conducting science, and the timely publication of results.* Each rejection adds time and adds time between when research is complete and when others can learn about it. Science is best served if review is fast and work only needs to be revised to meet the expectation of one set of reviewers, not an ever-changing cast of reviewers with different subjective biases and expectations.

---

Peer review cannot help but be systemically toxic when co-opted for ranking. In rejecting papers, reviewers feel obligated to provide feedback that justifies the outcome to their fellow committee members, to themselves, and to the authors—feedback that must inevitably focus on shortcomings to justify rejection. A system that must reject the majority of papers, and provide feedback focused on justifying rejection, is harmful to the mental health of the community receiving far more negative feedback than positive feedback.

The systems we've evolved to support rank-focused peer review are also toxic to reviewers. We are burdened by the work of reviewing papers that had already met scientific integrity requirements when previously rejected. We write feedback to authors who may ignore it knowing we are unlikely to be reviewing the paper when they re-submit it. We feel obligated to participate in peer review because of its importance for protecting scientific integrity, but it is nearly impossible to do so without becoming complicit in the toxicity of the social stratification system built upon it. We are obligated to work with reviewers who abuse the subjectivity and anonymity of peer review, and obligated to protect their identities, while witnessing the trauma they inflict cause promising aspiring scientists to abandon careers in research.
